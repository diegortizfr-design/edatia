document.addEventListener("DOMContentLoaded", async () => {
    ...
    if (empresaNombreEl) empresaNombreEl.textContent = userData.nombre_empresa || "ERPod";
    ...
    if (logoImgEl) {
        if (userData.nombre_carpeta) {
            logoImgEl.src = `../../clientes/${userData.nombre_carpeta}/assets/logo.png`;
    ...
    modulos.forEach(mod => {
        ...
        // Agregar al menú lateral también
