...
async function bootstrap() {
  ...
  // Aumentar el límite de carga para manejar carteras grandes de Excel
  ...
  app.enableCors({
    origin: [
      ...
      'https://herramientas.edatia.com',
      'https://distribuidorababyworld.com',
      'https://www.distribuidorababyworld.com',
      'https://distribuidorababyworld.edatia.com',
      'https://glowxir.edatia.com',
      'http://localhost:5173',
      'http://localhost:5174',
      'http://localhost:5175',
      'http://localhost:3000',
